...
class Config(object):
	...
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6729447395:AAFUv6Ds_WFmb3ydnbu-XsXgnSYCgb83YLo")
	BOT_USERNAME = os.environ.get("BOT_USERNAME",'silentproviderbot')
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002014015207"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER","921365334"))
	DATABASE_URL = os.environ.get("DATABASE_URL",'mongodb+srv://data123:data123@cluster0.da0uyts.mongodb.net/?retryWrites=true&w=majority')
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL","0")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL",'-1002014015207')
...
╭────[ **🔅FɪʟᴇSᴛᴏʀᴇBᴏᴛ🔅**]────⍟
│
├🔸🤖 **My Name:** [THE SILENT PROVIDER](https://t.me/{BOT_USERNAME})
│
├🔸📝 **Language:** [𝐏𝐲𝐭𝐡𝐨𝐧𝟑](https://www.python.org)
│
├🔹📚 **Library:** [𝐏𝐲𝐫𝐨𝐠𝐫𝐚𝐦](https://docs.pyrogram.org)
│
├🔸👨‍💻 **Developer:** [@Unknown](https://t.me/the_silent_teams) 
│
├🔹👥 **Bot Support:** [𝐒𝐮𝐩𝐩𝐨𝐫𝐭](https://t.me/Robo_5_0)
│
├🔸🔔 **Bot Updates:** [𝐔𝐩𝐝𝐚𝐭𝐞𝐬](https://t.me/the_silent_teams)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** [@The_Silent_Teams](https://t.me/The_Silent_Teams) 
